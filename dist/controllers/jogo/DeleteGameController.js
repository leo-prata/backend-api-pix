...
const DeleteGameService_1 = __importDefault(require("../../services/jogo/DeleteGameService"));
class DeleteGameController {
    handle(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            try {
                yield DeleteGameService_1.default.execute(id);
...
exports.default = new DeleteGameController();
